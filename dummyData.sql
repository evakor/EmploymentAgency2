...
VALUES 
(100, 'DUMMY John', 'Doe', 'North', '1234 North St', 1234567890, 9876543210, 'john.doe@example.com', '$2a$10$qtUFFgiJ0XqE2Ml.gq8dCumyNhVtZH9oaEPTgOjAffkvL9I4lgonO', 'Engineer', 'Software', 'static/user_profile.jpg', '/docs/john_cv.pdf');

INSERT INTO "EMPLOYEE" ("id", "firstName", "lastName", "region", "address", "phone1", "phone2", "email", "password", "occupation", "specialty", "profilePicturePath", "cvPath")
VALUES 
(101, 'DUMMY Jane', 'Smith', 'East', '5678 East Ave', 2345678901, 8765432190, 'jane.smith@example.com', '$2a$10$qtUFFgiJ0XqE2Ml.gq8dCumyNhVtZH9oaEPTgOjAffkvL9I4lgonO', 'Designer', 'Graphic', 'static/user_profile.jpg', '/docs/jane_cv.pdf');

INSERT INTO "EMPLOYEE" ("id", "firstName", "lastName", "region", "address", "phone1", "phone2", "email", "password", "occupation", "specialty", "profilePicturePath", "cvPath")
VALUES 
(102, 'DUMMY Alice', 'Johnson', 'South', '9101 South Dr', 3456789012, 7654321980, 'alice.johnson@example.com', '$2a$10$qtUFFgiJ0XqE2Ml.gq8dCumyNhVtZH9oaEPTgOjAffkvL9I4lgonO', 'Analyst', 'Data', 'static/user_profile.jpg', '/docs/alice_cv.pdf');
...
VALUES 
(103, 'DUMMY Bob', 'Brown', 'West', '2345 West Blvd', 4567890123, 6543219870, 'bob.brown@example.com', '$2a$10$qtUFFgiJ0XqE2Ml.gq8dCumyNhVtZH9oaEPTgOjAffkvL9I4lgonO', 'BobTech', 'Technology solutions provider.', 'static/user_profile.jpg');

INSERT INTO "EMPLOYER" ("id", "firstName", "lastName", "region", "address", "phone1", "phone2", "email", "password", "companyName", "companyDesc", "profilePicturePath")
VALUES 
(104, 'DUMMY Lisa', 'White', 'Central', '6789 Center Cir', 5678901234, 5432198760, 'lisa.white@example.com', '$2a$10$qtUFFgiJ0XqE2Ml.gq8dCumyNhVtZH9oaEPTgOjAffkvL9I4lgonO', 'White Designs', 'Interior and graphic design services.', 'static/user_profile.jpg');

INSERT INTO "EMPLOYER" ("id", "firstName", "lastName", "region", "address", "phone1", "phone2", "email", "password", "companyName", "companyDesc", "profilePicturePath")
VALUES 
(105, 'DUMMY Gary', 'Green', 'North-East', '0123 Northeast Path', 6789012345, 4321987650, 'gary.green@example.com', '$2a$10$qtUFFgiJ0XqE2Ml.gq8dCumyNhVtZH9oaEPTgOjAffkvL9I4lgonO', 'Green Gardens', 'Landscape and garden design.', 'static/user_profile.jpg');
